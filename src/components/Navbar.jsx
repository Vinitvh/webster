...
function Navbar({ darkTheme, setDarkTheme }) {
  return (
    <div
      className="p-5 pb-auto flex flex-wrap 
            sm:justify-between justify-center items-center border-b dark:border-gray-700 border-gray-200"
    >
        ...
        <Link to="/">
          <p
            className="text-2xl bg-blue-500 font-bold text-white py-1 px-2 rounded dark:bg-gray-500 
                  dark:text-gray-900"
          >
            Webster <FcSearch className="inline" />
          </p>
        </Link>
        <button
          type="button"
